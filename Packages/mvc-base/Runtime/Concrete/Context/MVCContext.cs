...
namespace MVC.Base.Runtime.Concrete.Context
{
    public class MVCContext : CrossContext
    {
        ...
        public IMVCCommandBinder commandBinder{ get; set; }

        public IMVCFunctionBinder functionBinder { get; set; }
        ...
        protected override void mapBindings()
        {
            ...
            functionBinder = injectionBinder.BindCrossContextSingletonSafely<IMVCFunctionBinder, MVCFunctionBinder>();
        }
        ...
        protected override void addCoreComponents()
        {
            ...
            injectionBinder.Bind<IMVCCommandBinder>().To<MVCSignalCommandBinder>().ToSingleton();
        ...
        protected override void instantiateCoreComponents()
        {
            ...
            commandBinder = injectionBinder.GetInstance<IMVCCommandBinder>();
        ...
        {
            if (mediationBinder == null)
                throw new ContextException("MVCContext cannot mediate views without a mediationBinder", ContextExceptionType.NO_MEDIATION_BINDER);
        ...
        public void UnbindAllBinder()
        {
            ...
            MVCSignalCommandBinder commandBinder = this.commandBinder as MVCSignalCommandBinder;
