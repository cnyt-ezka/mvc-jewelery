...
namespace MVC.Base.Editor.Concrete.MVCCodeGeneration.Test.Wizards
{
    ...
    public class CreateTestScreenWizard : ScriptableWizard
    {
        ...
        [TextArea(8, 8)] public string Warnings =
            "Do not use 'View' or 'Screen' at Name field.\n" +
            "If you want to create a Fail Screen, just write 'Fail' to Name field.\n\n" +
            "Do not use 'On' prefix for ViewUnityActionList.\n" +
            "If you want to add restart and Home buttons to screen, just add 'Restart' and 'Home' to ViewUnityActionList.";
