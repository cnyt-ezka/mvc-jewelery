...
namespace MVC.Base.Editor.Concrete.MVCCodeGeneration.Test
{
            ...
            ViewManagerMediatorGenerationOperation.OperateArgs>
    {
        ...
        private const string AddListenerTemplate = "_view.{0} += On{0};";
        private const string RemoveListenerTemplate = "_view.{0} -= On{0};";
        ...
        {
            _viewEventList = startArg.UnityActionList;
            _name = startArg.Name;
            _type = startArg.Type;
            ...
            DirectoryHelpers.CreateOrGetFolderPath(_sharedSettings.ProjectViewPath, _name);  
        }
        ...
        private void CreateViewScript(string name = "")
        {
            ...
            ReplacePlaceholderWithTemplatedEventList(ref data, UnityActionPlaceholder, ViewUnityActionTemplate, _viewEventList,"\r\t\t");
            
            ReplacePlaceholderWithTemplatedEventList(ref data, FunctionPlaceholder, ViewFunctionTemplate, _viewEventList,"\r\t\t");
