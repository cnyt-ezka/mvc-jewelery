...
namespace MVC.Base.Editor.Concrete.MVCCodeGeneration.Code.Wizards
{
    ...
    {
        [TextArea(5, 5)] public string Warnings =
            "Do not use 'Root' or 'Context' at Name field.\n" +
            "For example, if you want to create 'MinigameRoot', just write 'Minigame' to Name field.";
