...
namespace MVC.Base.Editor.Concrete.ModelViewer
{
    public class ModelViewer : OdinEditorWindow
    {
        ...
        private readonly List<Type> _ignoredTypeList = new List<Type>()
        {
            ...
            typeof(IMVCCommandBinder),
            typeof(IMVCFunctionBinder),
            typeof(IMVCScreenBinder),
        ...
        private void DrawModels()
        {
            ...
            foreach (object mainKey in bindingDictionaries.Keys)
            {
                ...
                {
                    var inspectWindow = CreateWindow<ModelInspectWindow>();
                    inspectWindow.SetInspectObject(_inspectedRoot.context as CrossContext, instance);
                    InspectObject(inspectWindow, instance);
                }
